...
begin
  ...
  create temporary table if not exists _session_type_dedup_map (
    duplicate_id uuid primary key,
    canonical_id uuid not null
  ) on commit drop;

  truncate table _session_type_dedup_map;

  insert into _session_type_dedup_map (duplicate_id, canonical_id)
  select
